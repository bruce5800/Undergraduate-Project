"""
bench/tester.py — BenchmarkTester 核心基准测试类

从 brenchmark.py 拆分：checkpoint 模式 + 多种子统计 + Mann-Whitney 检验。
输出 benchmark_raw.csv / benchmark_summary.csv / statistical_tests.csv
与 run_manifest.json（精确 CLI + git commit + 种子）。
"""
