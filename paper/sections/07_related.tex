...
game-theoretic RL to multi-objective LLM scheduling across
geo-distributed cloud datacenters (no edge tier). On the cloud-edge side,
...
Lyapunov-assisted DRL partitions transformer computation at
sub-layer granularity across
...
without learning~\cite{yu2025llmrouting}---we implement it as
our strongest baseline (\S\ref{sec:eval}); and
