...
request lifecycle---then evaluated ten schedulers spanning
load-balancing heuristics, classic and metaheuristic DAG
schedulers, a PerLLM-style constrained-bandit
(CS-UCB~\cite{yang2024perllm}), and three RL variants (PPO
...
dominance} over nine strong baselines on the (\slo{}
...
five strongest comparators and on energy efficiency against
three of five (PSO and CS-UCB directionally consistent,
others $p<0.05$). The Pareto
