...
key-value (KV) cache memory growth, continuous batching, the
...
and we compare it against nine strong baselines spanning
heuristic, load-balancing, bandit, and learned approaches.
